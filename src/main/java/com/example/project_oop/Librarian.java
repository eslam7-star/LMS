...
public class Librarian extends User {
    public Librarian(int ID, String Password, String FirstName, String LastName, String Address, String CellPhone, String Email, boolean isBlocked) {
        super(Password, "librarian", FirstName, LastName, Address, CellPhone, Email, isBlocked);
    }
